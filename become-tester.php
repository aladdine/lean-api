	...
	<div id="form-become-a-tester">
		...
		<form id="form-become-a-tester-step1">
		        ...
		        <div class="row">
			        ...
			        <div class="form-group col-md-2">
			          <label for="tester-github"> Github Page</label>
			        </div>
...
This Agreement and each party's obligations shall be binding on the representatives, assigns, and successors of such party. Each party has signed this Agreement through its authorized representative.
            ...
            <div class="col-md-2">
	      	...
	      	<div id="become-tester-confirmation">
	      		<h2>Congratulations, you can now start browsing and testing APIs: </h2>
	      		 <img id="tester-search-btn" src="images/buttons-01.png">
